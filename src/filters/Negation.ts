...
function negateSingle<FilePart extends Partial<TFile>>(
	filter: FileFilter<FilePart>,
): FileFilter<FilePart> {
...
export class Negation<FilePart extends Partial<TFile> = TFile> implements FileFilter<FilePart> {
